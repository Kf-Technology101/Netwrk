...
<div class="innerHeader">
    ...
    <div class="section group">
        ...
        <div class="col span_4_of_12"><a id="infobox" href="<?php bloginfo('url'); ?>/userinfo?uid=<?php echo $_GET['uid']; ?>"><div class="options"><i class="fa fa-info-circle" style="padding: 10px 12px;"></i></div></a></div>
    </div>
</div>