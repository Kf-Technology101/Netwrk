            ...
            <?php if(!is_user_logged_in()){ ?>
                <?php
                    if(isset($_POST['login'])){                    
                        ...
                        //echo $user_status1 = get_user_meta( $user_status[0]->ID, 'active', true );
                    ...
                    <div class="commonForm" style="padding: 0 5px 5px 5px;">
                        <form action="" method="post" autocomplete="off">
                            ...
                            <div class="loginLinks">
                                ...
                                <div style="display: none;"><a href="<?php bloginfo('url'); ?>/register">Register</a></div>
                ...
                <?php } else { ?>
                <?php header('Location: '.get_bloginfo('home').'/geo-map'); ?>
                <?php } ?>                         
	        </div>
            <div class="col span_4_of_12"></div>
	    </div>
